/*
 ...
 Source Schema         : mioflow

 Target Server Type    : MySQL
 Target Server Version : 90200 (9.2.0)
 File Encoding         : 65001

 Date: 24/03/2025 14:36:28
*/
...
CREATE TABLE `product_info` (
  ...
  `specification` varchar(100) DEFAULT NULL COMMENT '规格（增加单位信息）',
  ...
  `product_type` enum('管件','管材','线槽') DEFAULT NULL COMMENT '建材分类',
  PRIMARY KEY (`id`),
  KEY `idx_code` (`code`),
